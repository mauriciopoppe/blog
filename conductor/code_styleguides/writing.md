...
- "Delvings deeper into this topic..."
...
Use of unicode arrows (->), smart/curly quotes, em dashes (—), and other special characters that can't be easily typed on a standard keyboard. Real writers typing in a text editor produce straight quotes, standard hyphens (- or --), and -> or =>. Claude in particular loves the -> arrow.
...
- "The unicode em dash — like this — instead of double hyphens -- like this --."
