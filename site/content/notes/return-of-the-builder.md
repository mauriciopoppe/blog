...
Things changed in December with [conductor](https://github.com/gemini-cli-extensions/conductor). I tried it alongside other spec based agents and my view on agents capabilities changed so much! I realized that I could spend lots of time drafting the set of tasks, defining the boundaries of what I wanted to do and what I didn't want to do, then I'd enable YOLO during that period of time and things went so much better! I slowly trusted the agent more, slowly assigned larger work to the agent on larger tasks. Then the models got better and better and I realized I no longer needed so strong guardrails, I'd create a tiny plan and yolo it at once.
...
This means that the barrier to ship a new feature/product has shorted a lot. Anyone can come up with an idea, anyone can validate the idea by talking to an agent that represents the customer, anyone can build designs with the agents, anyone can spawn a swarm of agents to build the prototype and put it in the hands of customers as soon as possible to validate the idea, there's no need for large initial alignment beyond a small group of people that want to ship the feature/product, and there's nothing preventing me and my team to wear all the tech hats.
