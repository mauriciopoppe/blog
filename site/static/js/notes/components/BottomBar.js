    ...
    <footer class="tw-absolute tw-bottom-4 tw-left-4 tw-right-4 tw-pointer-events-none tw-flex tw-items-center tw-justify-between tw-text-xs tw-text-[var(--grey-light)] tw-z-20">
      ...
      <div class="tw-pointer-events-auto tw-flex tw-items-center tw-gap-3">
        <button
          id="graph-reset-zoom"
          onClick=${onResetZoom}
          class="tw-flex tw-items-center tw-gap-1.5 tw-px-3.5 tw-py-1.5 tw-rounded-full tw-bg-[var(--grey-dark)] tw-border tw-border-[var(--ring-border)] tw-shadow-subtle hover:tw-border-[var(--accent-border)] hover:tw-shadow-raised hover:tw-text-primary tw-transition tw-font-serif tw-text-xs tw-cursor-pointer"
