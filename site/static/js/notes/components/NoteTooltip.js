...
export function NoteTooltip({ node, pos }) {
  ...
  return html`
    <div
      ...
      class="tw-absolute tw-pointer-events-none tw-opacity-100 tw-transition-opacity tw-duration-150 tw-z-40 tw-bg-[var(--grey-dark)]/95 tw-backdrop-blur-xl tw-border tw-border-[var(--ring-border)] tw-shadow-raised tw-rounded-xl tw-p-5 tw-max-w-[480px]"
